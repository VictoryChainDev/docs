...
3. Add your network to Metamask using these parameters from Victory Chain:
    - Network Name: Victory Chain Testnet
    - New RPC URL: https://testnet.rpc.victorychain.io/
    - Chain ID: 199207251
    - Currency Symbol: VICTRY
    - Block Explorer URL: https://testnet.explorer.victorychain.io/
